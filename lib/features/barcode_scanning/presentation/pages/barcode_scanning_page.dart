  ...
  void _handleBarcode(BarcodeCapture capture) async {
     ...
     if (mounted) {
       ...
       _resetScanTimer = Timer(const Duration(seconds: 5), () {
          if (mounted) {
             debugPrint('[BarcodeScanningPage] Resetting last scanned value after 5 seconds.');
             _lastScannedValue = '';
             setState(() { _productInfo = 'Point camera at a barcode'; });
          }
       });
     }
  }
         ...
         body: Center(
            child: Column(
              ...
              children: [
                 ...
                 SizedBox(height: 16),
                 Text("Initializing Scanner...", style: TextStyle(color: Colors.white)),
              ],
            ),
         )
      );
